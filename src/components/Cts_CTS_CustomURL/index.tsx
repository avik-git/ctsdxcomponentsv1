...
import StyledCtsCtsCustomUrlWrapper from './styles';

// interface for props
interface CtsCtsCustomUrlProps extends PConnFieldProps {
...
function CtsCtsCustomUrl(props: CtsCtsCustomUrlProps) {
  const {
    getPConnect,
    value,
    hideLabel = false,
...
export default withConfiguration(CtsCtsCustomUrl);
